# RepRight documentation index

| Document | Purpose |
|----------|---------|
| [`architecture.md`](architecture.md) | Data flow, modules, state machine overview |
| [`live-session-flow.md`](live-session-flow.md) | UI states 7A–7D, banners, pose lost |
...
Design HTML prototypes: [`design-system/screens-v3/`](design-system/screens-v3/)
